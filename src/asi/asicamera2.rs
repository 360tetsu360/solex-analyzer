...
pub const ASI_CONTROL_TYPE_ASI_GPS_SUPPORT: ASI_CONTROL_TYPE = 24;
pub const ASI_CONTROL_TYPE_ASI_GPS_START_LINE: ASI_CONTROL_TYPE = 25;
pub const ASI_CONTROL_TYPE_ASI_GPS_END_LINE: ASI_CONTROL_TYPE = 26;
pub const ASI_CONTROL_TYPE_ASI_ROLLING_INTERVAL: ASI_CONTROL_TYPE = 27;
...
extern "C" {
    ...
    pub fn ASIGetDebugLogIsEnabled(
        iCameraID: ::std::os::raw::c_int,
        bEnable: *mut ::std::os::raw::c_int,
    ) -> ::std::os::raw::c_int;
}
